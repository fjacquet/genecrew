...
def build_deces_proposition(person: PersonFacts, match: dict, score: float,
...
def render_deces_report(scope: str, date: str, props: list[PropositionAudit], *,
                        candidates: int, queried: int, errors: int) -> str:
...
def run_deces(client: GrampsClient, scope: str, output_dir: Path, *, date: str,
    ...
    report = render_deces_report(scope, date, props, candidates=candidates,
