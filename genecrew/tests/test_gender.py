...
_P_CONTRA = Proposition(
    type="genre_contradiction",
    gramps_id="I0002",
    handle="h2",
    personne="Marguerite Dupont",
    valeur_actuelle="M",
    valeur_proposee="F",
...
def test_render_report_orders_and_links():
    md = render_gender_report(
        "all",
        "2026-07-18",
        [_P_INCONNU, _P_CONTRA],
        [("I0003", "Dominique", "unisexe/rare")],
        people_count=42,
    )
...
PEOPLE = [
    ...
    },
    {
        "handle": "h2",
        "gramps_id": "I0002",
        "gender": 1,  # M mais prénom F -> contradiction
        "primary_name": {
    ...
    },
    {
        "handle": "h3",
        "gramps_id": "I0003",
        "gender": 2,  # inconnu, unisexe -> indécidable
        "primary_name": {
            "first_name": "Dominique",
            "surname_list": [{"surname": "Roy"}],
        },
    },
    {
        "handle": "h4",
        "gramps_id": "I0004",
        "gender": 0,  # F et prénom F -> rien
        "primary_name": {
            "first_name": "Suzanne",
    ...
    },
    {
        "handle": "h5",
        "gramps_id": "I0005",
        "gender": 2,  # inconnu, ratio 0.96 -> confiance moyenne
        "primary_name": {
            "first_name": "Camille",
            "surname_list": [{"surname": "Petit"}],
        },
    },
]
...
def test_run_gender_is_read_only_and_classifies(tmp_path):
    ...
    assert (
        by_id["I0001"]["type"] == "genre_inconnu"
        and by_id["I0001"]["valeur_proposee"] == "F"
    )
    assert by_id["I0002"]["type"] == "genre_contradiction"
    assert (
        by_id["I0002"]["valeur_actuelle"] == "M"
        and by_id["I0002"]["valeur_proposee"] == "F"
    )
